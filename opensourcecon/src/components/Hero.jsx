      ...
      <div className="max-w-container mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            {/* Main Heading */}
            <h1 className="font-heading text-5xl md:text-6xl lg:text-[68px] font-extrabold leading-[1.05] tracking-tight">
              Where Kolkata
              <br />
              Meets
              <br />
            ...
            <div className="flex flex-wrap gap-8 pt-4">
              <div className="flex items-center gap-2">
                ...
                <span className="font-heading font-bold text-lg">500+</span>
                <span className="text-gray-secondary text-sm">Attendees</span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-heading font-bold text-lg">10+</span>
                <span className="text-gray-secondary text-sm">Tracks</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative flex items-center justify-center lg:justify-end">
            <div className="relative w-[320px] h-[320px] md:w-[400px] md:h-[400px]">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-24 h-24 md:w-28 md:h-28 rounded-full bg-dark flex items-center justify-center shadow-2xl">
                  <span className="text-brand-green text-3xl md:text-4xl font-mono font-bold">&lt;/&gt;</span>
                </div>
              </div>
              ...
              <svg className="absolute inset-0 w-full h-full" viewBox="0 0 400 400" fill="none">
                <line x1="200" y1="55" x2="200" y2="150" stroke="#E5E7EB" strokeWidth="1" strokeDasharray="4 4" />
                <line x1="345" y1="200" x2="250" y2="200" stroke="#E5E7EB" strokeWidth="1" strokeDasharray="4 4" />
                <line x1="200" y1="345" x2="200" y2="250" stroke="#E5E7EB" strokeWidth="1" strokeDasharray="4 4" />
                <line x1="55" y1="200" x2="150" y2="200" stroke="#E5E7EB" strokeWidth="1" strokeDasharray="4 4" />
              </svg>
            </div>
          </div>
        </div>
