    ...
    <section id="faq" className="py-20 lg:py-28 relative">
      <div className="max-w-container mx-auto px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
          {/* Header */}
          <h2 className="font-heading text-4xl md:text-5xl font-extrabold leading-[1.1] tracking-tight mb-12">
            Got questions?
            <br />
              ...
              <div key={i} className="faq-item" onClick={() => toggle(i)}>
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-heading font-bold text-base mb-0">
                      {faq.q}
                    </h3>
                    {openIndex === i && (
                      <p className="text-gray-secondary text-sm leading-relaxed mt-3 animate-fade-up">
                        {faq.a}
                      </p>
                    )}
                  </div>
